                ...
                <table id="example1" class="table table-hover">
                  ...
                  <td>{{$course->description}}</td>
                    <td>
                      ...
                      <a href="{{route('admin.addcollege',$course->id)}}" title="add Colleges" href="" class="btn btn-sm"><i class="fa fa-plus"></i></a>
                      <a href="{{route('admin.addexam',$course->id)}}" title="add Entrance Exams" href="" class="btn btn-sm"><i class="fa fa-plus"></i></a>
